...
public static void printMenu()
	{
			System.out.println("\n Welcome "+namn+" to MY BANK/ vår nya kund ");
			System.out.println(" ====");
			System.out.println("0: Quit");
			System.out.println("1: Deposit" );
			System.out.println("2: Withdraw");
			System.out.println("3: Show account information");
			System.out.println("4: Skapa ett Användarkonto som du kan logga in med");
			System.out.println("5: Skapa ett lösenord");
			System.out.println("6: Generera ett kontonummer");
			System.out.println("7: Ta reda på ditt kontonummer");
			System.out.print("\nEnter your choice: ");
	}
...
public static void dispatch(int choice)
	{
		switch(choice)
		{
			...
			case 2:
					System.out.println( "Lägg till koden om du vill göra withdraw");
					break;
			case 3:
					...
					nr = scan.nextInt();
						...
						break;
			case 4:
						System.out.println("Skriv in ett användarnamn och se om det är lämpligt :");
						String anv=scan.next();
						TheFirstUser.setLogin(anv);
						account1.changeName(anv);
						break;
			case 5: 	
						System.out.println("Skriv in ditt lösenord till ditt användarkonto och se om det är tillräckligt bra :");
					...
					String seeIfUser=scan.next();
						if(seeIfUser.matches(namn))
							...
							//System.out.println(TheFirstUser.getpassword());
									...
									{
										System.out.println("skriv nu in ditt lösenord :\n Skriv \"stop\" för att Avsluta");
										...
										if(seeIfPass.matches(TheFirstUser.getpassword()))
										{
											...
											System.out.println("Ditt kontonummer är följande :"+kontonmret);
											
										}
										else 
										{
											System.out.println("Du skrev in fel lösenord!");
										}
